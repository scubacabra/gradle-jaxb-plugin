...
* TODO put processing in for illegal arguments in the XJC tasks, and throw errors.
** TODO Like that every episode file binding actually exists
** TODO That directories exist
*** TODO Binding Diretory
*** TODO Episodes directoty
*** etc.
